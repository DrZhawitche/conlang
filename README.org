...
Plurals (for both nouns and adjectives) is done by adding an "/n/" at the end. "/N/" should thus be avoided the last letter of a word. Also note that any long vowels that might come at the end of the word turn into simple short ones after an "/n/" is added.
