...
*** 2.3 Defineteness
In [language name], nouns are by default indefinite. To make them definite, the article "/ha/" or "/han/" (depending on the number) is required. Check [[#42-articles][4.2 Articles]] for more information.
